...
if __name__ == "__main__":
    Bridge = Superstructure([45, ] * 4 + [35, ], 65.0, 50.0, pr_detail=False)
    ...
    S8.addStrand(125, pre_stressing, 12 * 140, )
    S8.addStrand(175, pre_stressing, 8 * 140, )
    S8.addStrand(1955, pre_stressing, 4 * 140, )
    S8.addTendon(320, 1338, 1 * Tn1 * 140, 1)
    S8.addTendon(440, 1338, 1 * Tn1 * 140, 2)
    S8.addTendon(560, 1338, 1 * Tn2 * 140, 2)
    S8.addTendon(680, 1338, 1 * Tn2 * 140, 2)
    ...
    R8 = Bridge.check_stress(4, 17.5, S8, True)
    ...
    print(Result)
    Result.to_excel("./res/4x45+35米应力计算结果.xlsx")
